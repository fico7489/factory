 ...
 */
final class Version20240320074416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, address_address VARCHAR(255) DEFAULT NULL, address_city VARCHAR(255) DEFAULT NULL, address_country VARCHAR(255) DEFAULT NULL, address_phone VARCHAR(255) DEFAULT NULL, INDEX IDX_F5299398A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE order_item (id INT AUTO_INCREMENT NOT NULL, order_price_item_id INT DEFAULT NULL, order_id INT DEFAULT NULL, product_id INT DEFAULT NULL, quantity INT NOT NULL, price DOUBLE PRECISION DEFAULT NULL, price_adjusted DOUBLE PRECISION DEFAULT NULL, subtotal DOUBLE PRECISION DEFAULT NULL, discount_global DOUBLE PRECISION DEFAULT NULL, discount_item DOUBLE PRECISION DEFAULT NULL, tax DOUBLE PRECISION DEFAULT NULL, total DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_52EA1F09D42AD2D0 (order_price_item_id), INDEX IDX_52EA1F098D9F6D38 (order_id), INDEX IDX_52EA1F094584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product_price_list (id INT AUTO_INCREMENT NOT NULL, user_group_id INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, sku VARCHAR(255) NOT NULL, INDEX IDX_AAFD55891ED93D47 (user_group_id), INDEX search (user_group_id, sku), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE order_item ADD CONSTRAINT FK_52EA1F09D42AD2D0 FOREIGN KEY (order_price_item_id) REFERENCES order_item_price (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_item DROP FOREIGN KEY FK_52EA1F09D42AD2D0');
